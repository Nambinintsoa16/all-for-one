...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row" style="margin-top:5px;letter-spacing: 1px;">
            <div class="col-lg-2  col-md-2   col-sm-2  col-xs-12">
                <a href="?page=livraison">
                    ...
                    <div class="" style="background:#04a5cc;height:95px;color:white;z-index:1;margin-top:-25px;">
                        <div style="text-align:center;padding-top:22px;font-size:18px">Livraison</div>
                        ...
                        <div style="height:30px;background:#038cae;margin-top:3px;padding-top:6px;text-align:center">
            ...
            <div class="col-lg-2   col-md-2   col-sm-2   col-xs-12">
                <a href="?page=listedesproduit">
                    ...
                    <div class="" style="background:#00a65a;min-height:95px;color:white;margin-top:-25px;">
                        <div class="count" style="text-align:center;padding-top:20px;font-size:18px">Produit</div>
                        <div style="text-align:center;font-size:18px">
                            <?php
            ...
            <div class="col-lg-2   col-md-2   col-sm-2   col-xs-12 ">
                <a href="?page=listedesclient">
                    ...
                    <div class="" style="background:#f39c11;min-height:95px;color:white;margin-top:-25px">
                        <div class="count" style="text-align:center;padding-top:20px;font-size:18px">Client</div>
                        <div style="text-align:center;font-size:18px">
                            <?PHP
            ...
            <div class="col-lg-2   col-md-2   col-sm-2   col-xs-12 ">
                <a href="?page=vente">
                    <div
                        style="position:relative;border-radius:50%;margin:auto;margin-top:-25px;width:50px;height:50px;background:white;z-index:111;border:solid 5px #8fc229">
                        <i class="fa fa-user"
                            style="z-index:1111;position:absolute;font-size:26px;padding-top:5px;padding-left:9px;color:#8fc229"></i>
                    </div>
            ...
            <div class="col-lg-2   col-md-2   col-sm-2   col-xs-12">
                <a href="?page=Livresondujour">
                    ...
                    <div class="" style="background:#dd4b39;min-height:95px;color:white;margin-top:-25px">

                        <div class="count" style="text-align:center;padding-top:20px;font-size:18px">Calendrier</div>
                        <div style="height:30px;background:#bb4031;margin-top:30px;padding-top:6px;text-align:center">
                            Plus d'info &nbsp; <i class="fa fa-arrow-circle-right"></i></div>
            ...
            <div class="col-lg-2   col-md-2   col-sm-2   col-xs-12">
                <a href="https://www.facebook.com/OneToOneMarketingAgency/" target="_blanc">
                    <div
                        style="position:relative;border-radius:50%;margin:auto;margin-top:-25px;width:50px;height:50px;background:white;z-index:111;border:solid 5px #12648a">
                        <i  class="fa fa-play"
                            style="z-index:1111;position:absolute;font-size:26px;padding-top:7px;padding-left:13px;color:#12648a"></i>
                    </div>

                    <div class="" style="background:#12648a;min-height:95px;color:white;margin-top:-25px">

                        <div class="count" style="text-align:center;padding-top:20px;font-size:18px">Autres</div>
                        <div style="height:30px;background:#0e4e6c;margin-top:30px;padding-top:6px;text-align:center">
                        </div>
