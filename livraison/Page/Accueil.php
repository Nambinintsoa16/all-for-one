            ...
            <div id="sidebar" class="nav-collapse "
                ...
                <ul class="sidebar-menu" style="color:#fff;z-index:234">
                    <div style="z-index:3456;background:#fff;width:100%;height:180px">
                        <img src="../img/w_16031121.jpg" alt=""
                        ...
                        <div
                            ...
                            <h3 style="text-align:center;font-size:16px;margin-top:4px">Service de Livraison</h3>
                        </div>
                    </div>
                    <li>
                        <a class="" href="?page=recap">
                            <i class="icon_house_alt"></i>
                            <span style="z-index:132">Accuiel</span>
                        </a>
                    </li>
                    <li class="sub-menu">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="?page=vente">Passez commande</a></li>
                        </ul>
                    </li>
                    <li class="sub">
